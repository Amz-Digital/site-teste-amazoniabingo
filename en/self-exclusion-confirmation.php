...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (removePlayer($url)) {
        ...
        redirectTo('/en/self-exclusion-success.php');
    } else {
        redirectTo('/en/self-exclusion-fail.php');
    }
}
...
<html lang="en">
    <head>        
        ...
        <title>Self deletion confirmation</title>
        <meta name="description" content="Service Terms">
    ...
    <body>
        ...
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v11.0" nonce="CAAejLVO"></script>
        ...
        <section id="header">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="bs-example-navbar-collapse-1">
                        <div class="nav-res d-flex">                            
                            <ul class="nav navbar-nav menu-inner">
                                <li><a href="/en/index.html#banner">Home</a></li>
                                <li><a href="/en/index.html#project-img">Games</a></li>
                                <li><a href="/en/index.html#faq">Support</a></li>
                            </ul>                            
                            <a class="navbar-brand" href="/en/index.html"><img src="/images/logo/amazonia-bingo.png" class="img-fluid logo-color" alt="logo amazonia bingo"></a>
                            ...
                            <ul class="social-media-box list-unstyled list-inline">
                                ...
                                <li class="btn-language list-inline-item" title="Select the Language">
            ...
            <nav id='cssmenu' class="hidden mobile">
                ...
                <ul>
                    <li><a href="/en/index.html#banner" class="active">Home</a></li>
                    <li><a href="/en/index.html#project-img">Games</a></li>
                    <li><a href="/en/index.html#faq">Support</a></li>
                </ul>
            </nav>
        ...
        <section id="inner-content" class="back-light section">
            <div class="container">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="">
                            <h3 class="text-uppercase font-italic pt-5">ARE YOU SURE?</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-justify justify-content-center text-center">
                    <div class="col-md-10">
                        <p>Deleting your account is irreversible. You will lose: Coin wallet, level, collections, star progress. If so, click "delete my account" below to begin.</p>
                    </div>
                    
                    <div class="row justify-content-center text-center">
                        <form method="POST">
                            <div clas="text-justify">
                                <input class="btn btn-danger pb-1" type="submit" value="Yes, delete my account">
                                <a href="/en/index.html" class="btn btn-secondary pb-1">Keep my account</a>
                            </div>
                        </form> 
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-5">
                        <div class="row contact-about">
                            <div class="col-12">
                                ...
                                <p>
                                    Amazonia Bingo welcomes you through a proposal of experience and incredible journey with prizes, jackpots,
                                    bingos and lots of emotion. Our support is ready to solve problems, learn, improve and delight our customers.
                                    We will be preparing news, new games, promotions through our social networks.
                                </p>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-md-12 bot-menu mb-5">
                        <div class="foot-menu">
                            <a href="/en/terms-of-service.html">Service Terms</a>
                            <span> | </span>
                            <a href="/en/terms-of-privacy-policy.html">Privacy Policy</a>
                            <span> | </span>
                            <a href="/en/terms-of-cookies-policy.html">Cookies Policy</a>
                            <span> | </span>
                            <a href="/en/responsible-game.html">Responsible Game</a>
                            <span> | </span>
                            <a href="/en/index.html#faq">Common Questions</a>
                        </div>
                    </div>
                    <div class="col-md-12 pb-5">
                        <div class="copy-right">
                            <h5>2021 &copy Amazonia Bingo. All rights reserved.</h5>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="select-language">
                            ...
                            <a href="/es/terms-of-service.html">
                                <img src="/images/flag/spain.png">
                            </a>
                            <a href="/en/terms-of-service.html">
                                <img src="/images/flag/usa.png">
                            </a>
                        </div>                                            
                    </div>
