...
<html lang="en">
    <head>        
        ...
        <title>Self deletion fail</title>
                ...
                <div class="container">
                    <div class="collapse navbar-collapse justify-content-between" id="bs-example-navbar-collapse-1">
                        <div class="nav-res d-flex">                            
                            ...
                            <a class="navbar-brand" href="/en"><img src="/images/logo/amazonia-bingo.png" class="img-fluid logo-color" alt="logo amazonia bingo"></a>
        ...
        <section id="inner-content" class="back-light section">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="">
                            <h3 class="text-uppercase font-italic pt-5">Failed to delete or non-existent account</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-justify justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="/en/index.html" class="btn btn-success pb-1">Go to home</a>
                    </div>                
                </div>          
            </div>
        </section>
