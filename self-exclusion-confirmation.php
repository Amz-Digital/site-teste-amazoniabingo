        ...
        <section id="inner-content" class="back-light section">
            <div class="container">
                ...
                <div class="row text-justify justify-content-center">
                    <div class="col-md-11">
                        <p>A exclusão de sua conta é irreversível. Você perderá: carteira de moedas, nível, coleções, progresso da estrela. Sendo assim, clique em "excluir minha conta" abaixo para excluír sua conta definitivamente.</p>
                    </div>
