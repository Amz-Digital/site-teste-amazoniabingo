...
<html lang="en">
    <head>        
        ...
        <title>Autoeliminación ha fallado</title>
        ...
        <section id="inner-content" class="back-light section">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="">
                            <h3 class="text-uppercase font-italic pt-5">Error al eliminar o cuenta inexistente</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-justify justify-content-center">
                    <div class="col-md-8 text-center">
                        <p>Póngase en contacto con nuestro soporte</p>
