...
<html lang="en">
    <head>        
        ...
        <title>Autoeliminación éxito</title>
        ...
        <section id="inner-content" class="back-light section">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="">
                            <h3 class="text-uppercase font-italic pt-5">Cuenta eliminada con éxito</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-justify justify-content-center">
                    <div class="col-md-8 text-center">
                        <p>Puedes volver a jugar en cualquier momento creando una nueva cuenta a través de nuestras aplicaciones o Facebook.</p>
                        <a href="/es/index.html" class="btn btn-success pb-1">Página de inicio</a>
                    </div>                
                </div> 
            </div>
        </section>
